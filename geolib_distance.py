#!/usr/bin/env python
'''
A modules that provides Geo Information with distance
between two IP addresses 
'''
__author__ = "Joon Ho Yang"
__copyright__ = "Copyright 2014, Joon Ho Yang"
__credits__ = ["Joon"]
__license__ = "GPL v3"
__version__ = "0.1"
__maintainer__ = "Joon Ho yang"
__email__ = "joonho.yang@yahoo.com"
__status__ = "beta"
